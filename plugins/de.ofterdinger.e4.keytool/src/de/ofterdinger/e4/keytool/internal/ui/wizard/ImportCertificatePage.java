...
public class ImportCertificatePage extends AbstractShowCertificatePage {
  ...
  public void createControl(Composite parent) {
    ...
    this.password =
        this.makeLine(composite, "&Certificate password", EMPTY, 4196352); // $NON-NLS-1$
  ...
  public boolean isNewKeystore() {
    return AbstractWizardPage.CREATE_A_NEW_KEYSTORE_TEXT.equals(
        this.keystoreCombo == null ? null : this.keystoreCombo.getText());
  }
  ...
  public boolean isWithPrivateKey() {
    if (this.importPrivateKeyCheckBox == null) return false;
