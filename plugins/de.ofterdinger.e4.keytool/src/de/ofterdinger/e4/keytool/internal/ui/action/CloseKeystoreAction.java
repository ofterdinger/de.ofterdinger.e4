...
import static de.ofterdinger.e4.keytool.internal.ui.util.ImageKeys.KEY_CLOSE;
...
public class CloseKeystoreAction extends AbstractKeytoolViewAction {
	...
	public final void run() {
		...
		if (selectedTreeObject != null) {
			...
			String filename = selectedTreeObject instanceof TreeParent ? ((TreeParent) selectedTreeObject).getKeystoreFilename()
